...
```{r get mean and sd habitat}
## mean natal HS
mean(juv_surv$hs_8km_natal)
# [1] 0.3756536
mean(sub_surv$hs_8km_natal)
# [1] 0.3886633
mean(ad_surv$hs_8km_natal)
# [1] 0.4063552

sd(juv_surv$hs_8km_natal)
# [1] 0.101517
sd(sub_surv$hs_8km_natal)
# [1] 0.1024055
sd(ad_surv$hs_8km_natal)
# [1] 0.09747033

## mean final HS
mean(juv_surv$hs_8km_final)
# [1] 0.3388906
mean(sub_surv$hs_8km_final)
# [1] 0.337044
mean(ad_surv$hs_8km_final)
# [1] 0.3476939

sd(juv_surv$hs_8km_final)
# [1] 0.1067531
sd(sub_surv$hs_8km_final)
# [1] 0.1040397
sd(ad_surv$hs_8km_final)
# [1] 0.1043546
```

```{r get mean and sd nterr}
## mean natal nterr
mean(juv_surv$nterr_dens_buffer50_first)
# [1] 21.16594
mean(sub_surv$nterr_dens_buffer50_first)
# [1] 19.77647
mean(ad_surv$nterr_dens_buffer50_first)
# [1] 19.35073

sd(juv_surv$nterr_dens_buffer50_first)
# [1] 14.75159
sd(sub_surv$nterr_dens_buffer50_first)
# [1] 14.42961
sd(ad_surv$nterr_dens_buffer50_first)
# [1] 14.36183


## mean natal nterr
mean(juv_surv$nterr_dens_buffer50_last)
# [1] 21.64657
mean(sub_surv$nterr_dens_buffer50_last)
# [1] 21.72394
mean(ad_surv$nterr_dens_buffer50_last)
# [1] 24.63462

sd(juv_surv$nterr_dens_buffer50_last)
# [1] 15.77476
sd(sub_surv$nterr_dens_buffer50_last)
# [1] 16.17725
sd(ad_surv$nterr_dens_buffer50_last)
# [1] 16.69232
```
...
zp1 <- ggplot(toplot_all_rn, aes(group = as.factor(model), 
  ...
  scale_color_manual(values = scico(4, begin = 0.15, palette = "tokyo"), 
                     name = "Age class") +
  # scale_color_viridis(option = "magma", begin = 0.3, end = 0.9,
  #                        guide = guide_legend(reverse = TRUE), discrete = TRUE) +
  # extra esthetics
  theme(
